...
minute and is confidently wrong on 26% of its definitive verdicts on the full case
set — 41% on the dev split (`eval/results/20260830-101148.json`,
`eval/results/20260830-102249.json`) — so acting on it requires re-deriving it
against the register.

**Scope, stated plainly:** the live requisitions illustrate; the full case evaluation
...
| 3 | Not performed | — | — | Closed 2026-08-30: two measurements and the sourcing finding stand; a third would not change the claim. The pre-registered three-requisition protocol and what was actually done stay visible side by side. |

The sample is one case where the manual process was slow and substituted an
estimate, and one where it was fast and correct. Two requisitions illustrate; the
